...
PICKS = {
    'sea-eagles-vs-rabbitohs': dict(
        ...
        tryscorer='Jason Saab', tryscorer_sub="Manly winger &middot; League's most prolific tryscorer this season &middot; Betr",
        ...
        analysis_paragraphs=[
            ...
            "At $1.57 the moneyline has zero value. The play is the &minus;4.5 line at $1.94 &mdash; Manly's edge talent, home venue and a Souths side that needs a re-set after a fortnight of injury chaos should be enough to cover. Jason Saab gets the anytime tryscorer pick at the standout finishing rate on the wing this season."
        ],
