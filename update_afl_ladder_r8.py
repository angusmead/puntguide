...
teams = [
    ...
    (2,  'finals-zone', False, 'Fremantle',          8, 7, 1, 0, 758, 570, '133.0', 28, 'HAW',  '$7.00',  'WWWWW', ''),
    (3,  'finals-zone', False, 'Hawthorn',           8, 6, 1, 1, 829, 684, '121.2', 26, 'FRE',  '$7.00',  'WWWWD', ''),
    (4,  'finals-zone', False, 'Brisbane Lions',     8, 5, 3, 0, 862, 684, '126.0', 20, 'CARL', '$4.00',  'WWLWW', ''),
    (5,  'finals-zone', False, 'Gold Coast SUNS',    8, 5, 3, 0, 806, 695, '116.0', 20, 'STK',  '$11.00', 'LLWLW', ''),
    (6,  'finals-zone', True,  'Geelong Cats',       8, 5, 3, 0, 791, 690, '114.6', 20, 'COLL', '$13.00', 'LWWLW', 'top6'),
    (7,  'finals-zone', False, 'Melbourne',          8, 5, 3, 0, 811, 809, '100.2', 20, 'WCE',  '$67.00', 'WLWWL', ''),
    (8,  'finals-zone', True,  'Collingwood',        8, 4, 3, 1, 666, 613, '108.6', 18, 'GEEL', '$34.00', 'LLWWD', ''),
    (9,  'danger-zone', False, 'St Kilda',           8, 4, 4, 0, 765, 666, '114.9', 16, 'GCFC', '$67.00', 'LWLWW', ''),
    (10, 'danger-zone', False, 'North Melbourne',    8, 4, 4, 0, 764, 720, '106.1', 16, 'SYD',  '$251.00','WLWLL', 'wc'),
    (11, 'danger-zone', False, 'Adelaide Crows',     8, 4, 4, 0, 685, 709, '96.6',  16, 'RICH', '$26.00', 'LWWLW', ''),
    (12, 'danger-zone', False, 'Western Bulldogs',   8, 4, 4, 0, 720, 787, '91.5',  16, 'PORT', '$41.00', 'WLLLL', ''),
    (13, 'danger-zone', False, 'Port Adelaide',      8, 3, 5, 0, 703, 634, '110.9', 12, 'WB',   '$101.00','WLLWL', ''),
    (14, 'danger-zone', False, 'GWS GIANTS',         8, 3, 5, 0, 668, 757, '88.2',  12, 'ESS',  '$41.00', 'LWLWL', ''),
    (15, 'danger-zone', False, 'West Coast Eagles',  8, 2, 6, 0, 557, 939, '59.3',   8, 'MELB', '$501.00','LLLLL', ''),
    (16, 'danger-zone', False, 'Carlton',            8, 1, 7, 0, 634, 812, '78.1',   4, 'BL',   '$501.00','LLLLL', ''),
    (17, 'danger-zone', False, 'Essendon',           8, 1, 7, 0, 649, 925, '70.2',   4, 'GWS',  '$501.00','LWLLL', ''),
    (18, 'danger-zone', False, 'Richmond',           8, 1, 7, 0, 523, 871, '60.0',   4, 'ADEL', '$501.00','LLLLW', ''),
]
